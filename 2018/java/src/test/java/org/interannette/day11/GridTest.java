...
public class GridTest {
    ...
    @Test
    void hundredsDigit() {
        assertEquals(3, Grid.hundredsDigit(12345));
        assertEquals(0, Grid.hundredsDigit(10));
        assertEquals(0, Grid.hundredsDigit(1000));
    }
    ...
    void powerLevel(PowerLevelTestCase powerLevelTestCase) {
        assertEquals(powerLevelTestCase.powerLevel,
                Grid.powerLevel(powerLevelTestCase.x, powerLevelTestCase.y, powerLevelTestCase.serialNumber));
    }
